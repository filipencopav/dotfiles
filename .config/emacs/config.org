...
#+begin_src emacs-lisp
  (elpaca (combobulate :host github :repo "mickeynp/combobulate")
    (provide 'elpaca-combobulate))
  (leaf combobulate
    :elpaca nil
    :after (go-ts-mode elpaca-combobulate)
...
#+begin_src emacs-lisp
  (elpaca (vue-ts-mode :host github :repo "8uff3r/vue-ts-mode")
    (provide 'elpaca-vue))
  (leaf vue-ts-mode
    :after (eglot typescript-ts-mode elpaca-vue)
